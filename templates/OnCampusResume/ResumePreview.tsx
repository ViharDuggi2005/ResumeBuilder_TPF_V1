...
const Section: React.FC<SectionProps> = ({
  ...
  <div
    className="mb-6 break-inside-avoid resume-section-container"
    data-splittable={splittable}
  >
    <div className="flex items-center mb-1 section-header-flex">
      ...
      <div
        className="flex-grow border-t-[4px] section-header-line"
      ...
      >
        <header className="flex items-start justify-between pb-4 text-[15px]">
          <div className="flex items-center flex-grow min-w-0">
            {personalDetails.logo && (
              <img
                ...
                alt="Institute Logo"
                className="h-36 w-36 mr-6 flex-shrink-0"
              />
            )}
          ...
          {personalDetails.photo && (
            <img
              ...
              alt="Profile"
              className="h-[140px] w-[130px] object-cover border-2 border-black ml-4 flex-shrink-0"
            />
          )}
        </header>
            ...
            <Section title="Educational Qualification">
              <div className="mt-3.5">
                <table className="w-full border-collapse border border-black text-black text-center text-[15px]">
                  <thead>
                    <tr>
                      <th className="border border-black p-2 font-bold h-[0.5in]">
                        Year
                      </th>
                      <th className="border border-black p-2 font-bold h-[0.5in]">
                        Degree/Examination
                  ...
                  <tbody>
                    {education.map((edu) => (
                      <tr key={edu.id}>
                        <td className="border border-black p-2 h-[0.5in]">
                          {edu.year}
                        </td>
                        <td className="border border-black p-2 h-[0.5in]">
                          {edu.degree}
              ...
              <ul className="custom-bullet-list technical-skills-list">
                {skills.map((skill) => (
                  <li key={skill.id} className="flex items-start">
                    <span className="w-56 flex-shrink-0 break-words">
                      {skill.category}
                    </span>
        ...
        >
          ...
          <div className="px-1">
            ...
            <p style={{ margin: 0 }}>
              Telephone : +91-431-2501081 | e-mail: tp@nitt.edu,
            </p>
